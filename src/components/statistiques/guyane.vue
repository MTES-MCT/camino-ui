<template>
  ...
  >
    ...
    >
      <h2>
        État du domaine minier en Guyane en temps réel
      </h2>
    ...
    <IndicateursActiviteGuyane
      v-if="tabActive === anneeCurrent - 2"
      :statistique-guyane="getStatistiqueGuyane(anneeCurrent - 2)"
    />
    <IndicateursActiviteGuyane
      v-if="tabActive === anneeCurrent - 1"
      :statistique-guyane="getStatistiqueGuyane(anneeCurrent - 1)"
    />
    <div
      id="evolution"
      class="mb-xxl"
