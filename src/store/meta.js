    ...
    try {
      ...
      if (metasIndex[id]) {
        ...
        if (res) {
          ...
          if (id === 'travaux-etapes-types') elements = res.travauxEtapesTypes
    ...
    try {
      ...
      if (metasIndex[id]) {
        ...
        if (res) {
          ...
          if (id === 'titres-types-types') elements = res.titreTypeTypeModifier
          ...
          if (id === 'demarches-statuts') elements = res.demarcheStatutModifier
          ...
          if (id === 'activites-statuts') elements = res.activiteStatutModifier
          if (id === 'activites-types--documents-types')
